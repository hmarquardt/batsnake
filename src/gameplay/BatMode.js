...
export class BatMode {
  ...
  dispose(){this.hud.hide();this.unsubscribe.forEach((fn)=>fn());this.echo.dispose();this.flock.dispose();this.snakes.dispose();}
}
